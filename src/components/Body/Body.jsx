      ...
      <section id="projects" className="body">
        <div id="card1">
          ...
          <p>
            ...
            un animal de compagnie. <br></br> <br />
        ...
        <div id="card2">
          ...
          <p>
            ...
            données. <br /> <br /> L'application permet de représenter
            graphiquement des informations complexes pour faciliter leur
            compréhension.
          </p>
          <a
        ...
        <div id="card3">
          <img id="img3" src={imageDataviz} alt="projet Dataviz" />
          <h2>Projet ???</h2>
          <p>
            Ce projet a été réalisé dans le cadre de ma formation en
            développement web. Il s'agit d'une application de visualisation de
